    ...
    <div class="container-inner">
      ...
      <div class="contact-form">
        ...
        <form action="" method="post">
          ...
          <input
            ...
            value="<?= isset($formData['objet']) ? htmlspecialchars($formData['objet'], ENT_QUOTES, 'UTF-8') : '' ?>"
            required
            <?= isset($formErrors['objet']) ? 'class="error"' : '' ?>>
          <?php if (isset($formErrors['objet'])): ?>
            <span class="error-message"><?= htmlspecialchars($formErrors['objet'], ENT_QUOTES, 'UTF-8') ?></span>
          <?php endif; ?>
      ...
      <div class="contact-infos">
        ...
        <div class="contact-mascotte">
          <img src="<?= BASE_URL ?>/assets/img/contact/contact.jpg"
        ...
        <div class="contact-details">
          ...
          <p class="hotline">📞 Support : 24h/7j</p>
        </div>

        <div class="contact-zone">
          <h4>Zones d’intervention</h4>
          <img src="<?= BASE_URL ?>/assets/img/contact/intervention.png"
